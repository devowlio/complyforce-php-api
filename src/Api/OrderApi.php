...
class OrderApi
{
     ...
     * Get orders overview
     *
     * @param   $vendorUuid Vendor UUID. The authenticated API key or JWT user must have access to this vendor. (required)
     ...
     * @param   $billingId Filter by vendor billing ID. (optional)
